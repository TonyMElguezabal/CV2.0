...
Records the evidence-based selection of the chatbot's LLM provider (GPT-5.4-mini, chosen over Claude Haiku 4.5) and retrieval approach (build-time embedding into a static index file, no vector database), per the JOS-61 comparative spike.
