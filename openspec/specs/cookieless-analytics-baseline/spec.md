...
Defines the client-side analytics baseline: cookieless, fingerprint-free page-view and section-reach tracking sent fire-and-forget to the first-party events endpoint, with no consent banner and a footer disclosure of the approach and retention period.
