...
Defines the proactive idle invitation bubble that introduces the chat assistant to a visitor who hasn't interacted with it — its cadence, session-scoped persistence, and the safety rules that keep a timer-driven popup from disrupting keyboard or assistive-technology users.
