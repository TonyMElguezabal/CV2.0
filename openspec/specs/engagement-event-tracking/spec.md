...
Defines the engagement and conversion event instrumentation for the four interactions that already exist — chat open, question submit, résumé download, and contact link activation — wiring them into the analytics `track()` helper without altering their own behavior.
