...
Defines the site-wide performance budget — the motion library is lazily loaded and kept out of the critical bundle, the initial JS budget is enforced, the landing page meets the Lighthouse ≥90 and LCP targets, and animations sustain 60fps.
