...
Defines the site's pre-résumé formative record (1994–2006) — the content
shape and editorial constraints that let decades-old material function as
an asset rather than a liability: legacy tooling stays narrative and is
never claimed as a current skill, and the career's span is published while
no birth date or current age ever is.
