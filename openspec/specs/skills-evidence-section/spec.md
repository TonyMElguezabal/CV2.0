...
Defines the Skills section: every skill from `content/skills.yaml` rendered with real links to the chapters that evidence it, so no skill claim ships without evidence (PRD §5 F4, §4.4).
