...
- [x] 6.1 After merge, sync `specs/contact-options/spec.md` (new capability) and the `hero-ctas` delta (REMOVED + ADDED requirements) into `openspec/specs/` and archive this change (per CLAUDE.md §10 / `opsx:archive`)
