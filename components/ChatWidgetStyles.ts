export const chatTriggerClass =
  "fixed bottom-6 right-6 z-40 rounded-full border border-zinc-700 bg-zinc-900 px-5 py-3 text-sm font-medium text-zinc-200 shadow-lg hover:border-zinc-500 hover:text-white";
...
export const chatCloseButtonClass =
  "rounded-full p-1 text-zinc-400 hover:bg-zinc-800 hover:text-white";
...
export const chatStarterQuestionButtonClass =
  "rounded-lg border border-zinc-700 px-3 py-2 text-left text-sm text-zinc-300 hover:border-zinc-500 hover:text-white";
...
export const chatCitationLinkClass =
  "rounded-full border border-zinc-600 px-2 py-0.5 text-xs text-zinc-400 hover:border-zinc-400 hover:text-zinc-200";

export const chatFormClass =
  "flex items-center gap-2 border-t border-zinc-800 px-3 py-3";

export const chatInputClass =
  "flex-1 rounded-full border border-zinc-700 bg-zinc-950 px-3 py-2 text-sm text-zinc-100 placeholder:text-zinc-500 focus:border-zinc-500 focus:outline-none";

export const chatSubmitButtonClass =
  "rounded-full border border-zinc-700 px-4 py-2 text-sm font-medium text-zinc-200 hover:border-zinc-500 hover:text-white disabled:cursor-not-allowed disabled:opacity-50";
