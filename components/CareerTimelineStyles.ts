...
export const timelineNodeClass =
  "group flex shrink-0 flex-col gap-1 border-l-2 border-zinc-800 py-1 pl-3 text-left transition-colors hover:border-zinc-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-4 focus-visible:outline-zinc-200 md:w-40";

export const timelineCompanyClass =
  "text-sm font-medium text-zinc-300 group-hover:text-white";
