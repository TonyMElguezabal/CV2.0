...
export const timelineNodeClass =
  "group flex shrink-0 flex-col gap-1 border-l-2 border-hair py-1 pl-3 text-left motion-safe:transition-colors hover:border-ink-meta aria-[current=location]:border-ink focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-4 focus-visible:outline-zinc-200 md:w-40";
